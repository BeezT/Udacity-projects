...
class MovieDetailViewController: UIViewController {
    ...
    @IBAction func toggleFavorite(_ sender: AnyObject) {
        ...
        let methodParameters = [
            Constants.TMDBParameterKeys.ApiKey:Constants.TMDBParameterKeys.ApiKey,
            Constants.TMDBParameterKeys.SessionID:appDelegate.sessionID!
        ]
        
        // parameters gotten from the Movie Database method documentation
        let headers = ["content-type": "application/json;charset=utf-8"]
        let postDataParameters = [ "media_type": "movie",
                                   "media_id": 550,
                                   "favorite": true] as [String:Any]
        
        //convert Foundation Object into JSON object
        let postData: Data!
        
        do {
            postData = try JSONSerialization.data(withJSONObject: postDataParameters, options: .prettyPrinted)
        } catch {
